...
`,e={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Version kitchen sink alignee sur la structure présenté dans components.html (image, body, list-group, liens, footer)."}}}},s={render:t,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemple de layout Bootstrap avec row-cols et cartes en hauteur uniforme via h-100."}}}},r={render:d,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante itou `c-card has-one-link-inside` avec un seul lien en `stretched-link` et une bordure bleu au survol."}}}},i={render:l,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante itou `c-card has-links-inside` avec plusieurs liens et une bordure grise au survol."}}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
