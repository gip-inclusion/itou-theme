import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;function C(){return(C=e((()=>{t={title:`Components/Box Results`,decorators:[e=>`<div style="max-width: 1000px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`,r={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de `.c-box.c-box--results` avec les variations de contenu spécifique possible pour une carte de résultat de recherche employeurs"}}}},i=()=>`
<div class="c-box c-box--results has-links-inside my-3 my-md-4">
  <div class="c-box--results__header">
    <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
...
`,a={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de `.c-box.c-box--results` pour les postes ouverts au recrutement"}}}},o=()=>`
...
`,s={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de `.c-box.c-box--results` avec le contenu spécifique  pour une carte de résultat de recherche prescripteurs"}}}},c=()=>`
...
`,l={render:c,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de `.c-box.c-box--results` avec le contenu spécifique pour une carte de candidat sous la vue employeur / prescripteur puis sous la vue du candidat"}}}},u=()=>`
...
`,d={render:u,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de `.c-box.c-box--results` avec le contenu spécifique pour une carte de fiches salariés ASP"}}}},f=()=>`
<div class="c-box c-box--results has-links-inside">
  <div class="c-box--results__header">
    <div class="c-box--results__summary">
      <i class="ri-user-line" aria-hidden="true"></i>
...
`,p={render:f,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemple de `.c-box.c-box--results` avec le contenu spécifique pour une carte de fiches salariés et PASS IAE"}}}},m=()=>`
<div class="c-box c-box--results has-links-inside">
  <div class="c-box--results__header">
    <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
      <div class="c-box--results__summary flex-grow-1">
...
`,h={render:m,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de `.c-box.c-box--results` pour le controle a posteriori - vue DDETS - carte SIAE"}}}},g=()=>`
<div class="c-box c-box--results has-links-inside">
  <div class="c-box--results__header">
    <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
      <div class="c-box--results__summary flex-grow-1">
...
`,_={render:g,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de `.c-box.c-box--results` pour le controle a posteriori - vue DDETS - carte auto-prescription"}}}},v=()=>`
<div class="c-box c-box--results has-links-inside">
  <div class="c-box--results__header">
    <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
      <div class="c-box--results__summary flex-grow-1">
...
`,y={render:v,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de `.c-box.c-box--results` pour le controle a posteriori - vue SIAE - carte auto-prescription"}}}},b=()=>`
<div class="c-box c-box--results has-one-link-inside">
  <div class="c-box--results__header">
    <div class="c-box--results__summary">
      <i class="ri-community-line" aria-hidden="true"></i>
...
`,x={render:b,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemple de `.c-box.c-box--results` pour DORA"}}}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...x.parameters?.docs?.source}}},S=[`EmployeursSIAE`,`PostesOuvertsAuRecrutement`,`Prescripteurs`,`Candidats`,`SalariesASP`,`SalariesEtPassIAE`,`ControleAPosterioriDDETSSiae`,`ControleAPosterioriDDETSAutoPrescription`,`ControleAPosterioriSIAEAutoPrescription`,`Dora`]})))()}C();export{l as Candidats,_ as ControleAPosterioriDDETSAutoPrescription,h as ControleAPosterioriDDETSSiae,y as ControleAPosterioriSIAEAutoPrescription,x as Dora,r as EmployeursSIAE,a as PostesOuvertsAuRecrutement,s as Prescripteurs,d as SalariesASP,p as SalariesEtPassIAE,S as __namedExportsOrder,t as default};