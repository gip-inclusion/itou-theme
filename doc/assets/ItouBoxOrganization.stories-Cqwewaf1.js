import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i;function a(){return(a=e((()=>{t={title:`Components/Box Organization`,decorators:[e=>`<div style="max-width: 480px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`,r={render:n,args:{collapsible:!1},argTypes:{collapsible:{name:`Collapsible`,control:{type:`boolean`},description:`Active la version repliable de la box organization.`,table:{category:`Options`}}},parameters:{docs:{description:{story:"\nVersion complète de fiche organisation. Passer `Collapsible` à `true` pour activer l'affichage repliable Bootstrap.\n"}}}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
