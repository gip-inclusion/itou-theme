...
<section class="vstack gap-3">
  ...
  `,r={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Utilitaires texte : alignement, casse, retour à la ligne, style et états (Bootstrap + custom itou).`}}}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
