...
`,t={render:i,parameters:{docs:{description:{story:"L'infobulle peut être affichée sur un bouton, un lien ou une icône (sur une icone il faut rendre le texte du tooltip accessible avec un aria-labe et un tabindex)."}}}},s=()=>`
  <div class="d-flex gap-3">
