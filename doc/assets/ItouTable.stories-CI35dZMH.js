        ...
        <tr>
          ...
          <td class="text-end w-100px">
            <div class="btn-group btn-group-sm" role="group" aria-label="Actions rapides sur le candidat">
              ...
              <button class="btn btn-link btn-ico-only" type="button" id="dropdown_${t}_action_menu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Plus d'actions">
                <i class="ri-more-2-fill" aria-hidden="true"></i>
              </button>
              <div class="dropdown-menu" aria-labelledby="dropdown_${t}_action_menu">
...
${d}`},a={render:i,parameters:{docs:{description:{story:`Table de base paramétrée par args (compacte, zebra, hover, bordures, responsive, triable).`}}},args:{compact:!1,striped:!1,hover:!1,bordered:!1,responsive:!1,responsiveBreakpoint:`all`,sortable:!1}},o={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variation compacte avec `.table-sm`."}}},args:{compact:!0,striped:!1,hover:!1,bordered:!1,responsive:!1,responsiveBreakpoint:`all`,sortable:!1}},s={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Cas d'usage avec lignes zebrees et survol des lignes.`}}},args:{compact:!1,striped:!0,hover:!0,bordered:!1,responsive:!1,responsiveBreakpoint:`all`,sortable:!1}},c={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Table avec conteneur responsive (scroll horizontal sur petits écrans).`}}},args:{compact:!1,striped:!1,hover:!1,bordered:!1,responsive:!0,responsiveBreakpoint:`all`,sortable:!1}},l={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:'Version triable avec `.table-sortable` et attribut `data-bs-table="sortable"`.'}}},args:{compact:!1,striped:!1,hover:!0,bordered:!1,responsive:!1,responsiveBreakpoint:`all`,sortable:!0}},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: renderTable,
  parameters: {
    docs: {
      description: {
...
}`,...l.parameters?.docs?.source}}},u=[`Default`,`Compact`,`StripedAndHover`,`Responsive`,`Sortable`]})))()}d();export{o as Compact,a as Default,c as Responsive,l as Sortable,s as StripedAndHover,u as __namedExportsOrder,t as default};