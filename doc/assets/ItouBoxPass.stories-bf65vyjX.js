import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a;function o(){return(o=e((()=>{t={title:`Components/Box PASS`,decorators:[e=>`<div style="max-width: 480px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`}}}},n=({boxClasses:e,badgeClasses:t,badgeIcon:n,badgeLabel:r,endDateClass:i=``,validityClass:a=``,extraBlock:o=``,validiteLabel:s=`Duree de validite`,validiteValue:c=`721 jours (environ 1 an, 2 mois, 12 jours)`})=>`
<div class="c-box c-box--pass ${e}">
  <div class="mb-3 mb-md-4">
    <span class="badge badge-base rounded-pill ${t}">
      <i class="${n}" aria-hidden="true"></i>
      ${r}
    </span>
  </div>
  ...
  <ul class="list-data mb-3 mb-md-4">
    ...
    <li>
      ...
      <strong class="${i}">04/07/2026</strong>
    </li>
    <li>
      <small>
        ${s}
...
`,r=()=>`
  <div class="vstack gap-4">
    ${n({boxClasses:`bg-success-lightest border-success`,badgeClasses:`bg-success text-white`,badgeIcon:`ri-pass-valid-line`,badgeLabel:`PASS IAE valide (non demarre)`,validityClass:`text-success`})}

    ${n({boxClasses:`bg-success-lightest border-success`,badgeClasses:`bg-success text-white`,badgeIcon:`ri-pass-valid-line`,badgeLabel:`PASS IAE valide`,validityClass:`text-success`,extraBlock:`
    ...
    ${n({boxClasses:`bg-info-lightest border-info`,badgeClasses:`bg-info text-white`,badgeIcon:`ri-pass-pending-line`,badgeLabel:`PASS IAE valide (suspendu)`,extraBlock:`
        <hr class="my-3 my-md-4">
        <ul class="list-data mb-3 mb-md-4">
          <li>
...
`,i={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Vue de référence regroupant les états métier les plus courants de `.c-box--pass`."}}}},i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
...
}`,...i.parameters?.docs?.source}}},a=[`AllStates`]})))()}o();export{i as AllStates,a as __namedExportsOrder,t as default};