...
<ul class="list-data">
  ...
  <li>
    ...
    ${n?`<i class="text-disabled">Non renseigne</i>`:`<strong>01 23 45 67 89</strong>`}
  </li>
  <li>
    <small>Adresse</small>
  ...
  <li>
    ...
    ${n?`<i class="text-disabled">Non renseigne</i>`:`<strong>1234567A</strong>`}
  </li>
  <li>
    <small>CV</small>
    ...
    `:``}
</ul>`.trim(),r=()=>`<div class="list-data-group">
  <ul class="list-data">
    <li>
      <small>Prenom</small>
      <strong>David</strong>
...
}`,...c.parameters?.docs?.source}}},l=[`Default`,`WithLongContent`,`CompleteData`,`ListdataGroup`]})))()}u();export{s as CompleteData,a as Default,c as ListdataGroup,o as WithLongContent,l as __namedExportsOrder,i as default};