const i=({modifier:t="",hasCta:s=!1})=>`
<section class="s-article-figure-01 ${t}">
    ...
    <div class="s-article-figure-01__row row">
      ...
      <div class="s-article-figure-01__col s-article-figure-01__col--article col-12 col-md-9 col-lg-8 d-flex align-items-center">
        <article>
          ...
          ${s?'<a href="#" class="btn btn-outline-primary w-100 w-md-auto">En savoir plus</a>':""}
        </article>
      </div>
    </div>
  </div>
</section>
`,a={title:"Sections/ArticleFigure01",decorators:[t=>`<div style="max-width: 1200px; margin: 0 auto;">${t()}</div>`],tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`}}}},e={render:()=>i({hasCta:!1}),parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Version par défaut sans CTA, conforme à la structure de base de la section."}}}},r={render:()=>i({modifier:"s-article-figure-01--ltr",hasCta:!0}),parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante avec modifieur `--ltr`."}}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
...
}`,...r.parameters?.docs?.source}}};const o=["Default","LTRWithCta"];export{e as Default,r as LTRWithCta,o as __namedExportsOrder,a as default};
