const c={title:"Components/Box Summary",decorators:[l=>`<div style="max-width: 1000px; margin: 0 auto;">${l()}</div>`],tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`,s={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante liste de documents avec statut et actions de téléchargement."}}}},e={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante chiffrée avec CTA principal pour contrôler la sélection."}}}},a={render:t,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante texte libre avec action de modification."}}}},r={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante de synthèse avec bloc d’information complémentaire."}}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
}`,...r.parameters?.docs?.source}}};const d=["Documents","Parcours","Commentaire","Recapitulatif"];export{a as Commentaire,s as Documents,e as Parcours,r as Recapitulatif,d as __namedExportsOrder,c as default};
