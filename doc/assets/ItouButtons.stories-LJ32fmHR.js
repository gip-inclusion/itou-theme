...
<button class="btn btn-ico btn-primary">
  ...
  `,o={render:I,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Créez des boutons avec une icône et du texte en `.btn-ico` et en enrobant le texte dans un `<span>`. Les icônes sont généralement à la gauche du texte."}}},args:{}},k=({size:e})=>`
  ...
  `,a={render:$,decorators:[e=>`<div style="min-height: 180px;">${e()}</div>`],parameters:{controls:{exclude:["variant","element","width","withIcon","disabled"]},docs:{controls:{exclude:["variant","element","width","withIcon","disabled"]},description:{story:"Les boutons dropdown contiennent l'icône avec la classe `dropdown-toggle` ."}}},args:{size:"default"}},z=()=>`
...
}`,...i.parameters?.docs?.source}}};const W=["Default","DisabledWithSpinner","WithIcon","IconOnly","WithDropdown","AllVersions"];export{i as AllVersions,t as Default,s as DisabledWithSpinner,r as IconOnly,a as WithDropdown,o as WithIcon,W as __namedExportsOrder,E as default};
