import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a,o,s;function c(){return(c=e((()=>{t={title:`Utilities/Spacing`,decorators:[e=>`<div style="max-width: 1200px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`}}}},n=[{key:0,formula:`0`,rem:`0`,px:`0px`},{key:1,formula:`$spacer * 0.25`,rem:`0.25rem`,px:`4px`},{key:2,formula:`$spacer * 0.5`,rem:`0.5rem`,px:`8px`},{key:3,formula:`$spacer`,rem:`1rem`,px:`16px`},{key:4,formula:`$spacer * 1.5`,rem:`1.5rem`,px:`24px`},{key:5,formula:`$spacer * 2`,rem:`2rem`,px:`32px`},{key:6,formula:`$spacer * 3`,rem:`3rem`,px:`48px`},{key:7,formula:`$spacer * 4`,rem:`4rem`,px:`64px`},{key:8,formula:`$spacer * 5`,rem:`5rem`,px:`80px`},{key:9,formula:`$spacer * 6`,rem:`6rem`,px:`96px`},{key:10,formula:`$spacer * 8`,rem:`8rem`,px:`128px`}],r=()=>`
      ...
      <div class="card-body p-0">
        <div class="table-responsive">
          <table class="table table-sm mb-0">
            ...
            <tbody>
              ${n.map(({key:e,formula:t,rem:n,px:r})=>`<tr><td><code>${e}</code></td><td><code>${t}</code></td><td>${n}</td><td>${r}</td></tr>`).join(``)}
            </tbody>
          </table>
        </div>
      </div>
...
<section class="vstack gap-4">
  ...
  `,o={render:a,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Notation, échelle et exemples visuels des utilitaires d'espacement.`}}}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render,
  parameters: {
    controls: {
      disable: true
...
}`,...o.parameters?.docs?.source}}},s=[`Default`]})))()}c();export{o as Default,s as __namedExportsOrder,t as default};