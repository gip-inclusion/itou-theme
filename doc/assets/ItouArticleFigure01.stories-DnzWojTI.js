import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a;function o(){return(o=e((()=>{t=({modifier:e=``,hasCta:t=!1})=>`
<section class="s-article-figure-01 ${e}">
    ...
    <div class="s-article-figure-01__row row">
      ...
      <div class="s-article-figure-01__col s-article-figure-01__col--article col-12 col-md-9 col-lg-8 d-flex align-items-center">
        <article>
          ...
          ${t?`<a href="#" class="btn btn-outline-primary w-100 w-md-auto">En savoir plus</a>`:``}
        </article>
      </div>
    </div>
  </div>
</section>
`,n={title:`Sections/ArticleFigure01`,decorators:[e=>`<div style="max-width: 1200px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`}}}},r={render:()=>t({hasCta:!1}),parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Version par défaut sans CTA, conforme à la structure de base de la section.`}}}},i={render:()=>t({modifier:`s-article-figure-01--ltr`,hasCta:!0}),parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante avec modifieur `--ltr`."}}}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => renderArticleFigure01({
    hasCta: false
  }),
  parameters: {
    controls: {
  ...
  render: () => renderArticleFigure01({
    modifier: "s-article-figure-01--ltr",
    hasCta: true
  }),
  parameters: {
    controls: {
...
}`,...i.parameters?.docs?.source}}},a=[`Default`,`LTRWithCta`]})))()}o();export{r as Default,i as LTRWithCta,a as __namedExportsOrder,n as default};