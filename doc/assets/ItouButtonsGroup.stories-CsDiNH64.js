...
`}}},argTypes:{size:{control:{type:`select`},options:[`default`,`sm`,`lg`],description:"Taille du groupe de boutons : standard, petit (`btn-group-sm`) ou grand (`btn-group-lg`)"}}},n=({size:e})=>{let t=e==="default"?``:`btn-group-${e}`;return`
  ...
  `},r={render:n,parameters:{docs:{description:{story:"Démonstration des tailles `.btn-group-lg`, défaut et `.btn-group-sm` et un exemple de `.btn-group` présent dans les tablaux de résultats."}}},args:{size:`sm`}},i=({size:e})=>`
  ...
  `,a={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variation Itou avec `.btn-group-action` pour des actions rapides icône seule."}}},args:{size:`sm`}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: render,
  parameters: {
    docs: {
      description: {
...
}`,...a.parameters?.docs?.source}}},o=[`Default`,`ActionGroup`]})))()}s();export{a as ActionGroup,r as Default,o as __namedExportsOrder,t as default};