import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a,o;function s(){return(s=e((()=>{t={title:`Components/Box Dashboard`,decorators:[e=>`
      <style>
        .c-box__header--dora {
...
`}}}},n=({hasBottomInfo:e,hasMainLink:t,hasTitleBadge:n,hasExtraBoxes:r})=>`
  <div class="c-box c-box--dashboard p-0 h-100">
    ...
    <div class="px-3 px-lg-4">
      ...
      `:``}
      <ul class="list-unstyled${e||r?``:` mb-lg-5`}">
...
`,i={render:n,args:{hasTitleBadge:!1,hasMainLink:!0,hasExtraBoxes:!1,hasBottomInfo:!1},parameters:{docs:{description:{story:"La Box Dashboard avec les options `hasMainLink`, `hasTitleBadge` et `hasBottomInfo` permettent d'activer les variantes."}}}},a={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante specifique DORA pour les services partenaires avec header `c-box__header--dora` et liste de liens externes d'action."}}}},i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render,
  args: {
    hasTitleBadge: false,
    hasMainLink: true,
...
}`,...a.parameters?.docs?.source}}},o=[`Default`,`ServicesPartenaires`]})))()}s();export{i as Default,a as ServicesPartenaires,o as __namedExportsOrder,t as default};