import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a;function o(){return(o=e((()=>{t={title:`Utilities/Images`,decorators:[e=>`<div style="max-width: 1000px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
<section class="vstack gap-4">
  <div class="vstack gap-2">
    ...
    <div class="border rounded p-2" style="max-width: 560px;">
      <img src="${n}" class="img-fluid" alt="Illustration d'exemple en image responsive" loading="lazy">
    </div>
  </div>
    ...
    <div class="d-flex flex-wrap gap-3">
      <figure class="mb-0">
        <div class="border rounded overflow-hidden" style="width: 200px; height: 120px;">
          <img src="${n}" class="w-100 h-100 object-fit-contain" alt="Exemple object-fit contain" loading="lazy">
        </div>
      ...
      <figure class="mb-0">
        <div class="border rounded overflow-hidden" style="width: 200px; height: 120px;">
          <img src="${n}" class="w-100 h-100 object-fit-cover" alt="Exemple object-fit cover" loading="lazy">
        </div>
      ...
      <figure class="mb-0">
        <div class="border rounded overflow-hidden" style="width: 200px; height: 120px;">
          <img src="${n}" class="w-100 h-100 object-fit-fill" alt="Exemple object-fit fill" loading="lazy">
        </div>
      ...
      <figure class="mb-0">
        <div class="border rounded overflow-hidden" style="width: 200px; height: 120px;">
          <img src="${n}" class="w-100 h-100 object-fit-scale" alt="Exemple object-fit scale" loading="lazy">
        </div>
      ...
      <figure class="mb-0">
        <div class="border rounded overflow-hidden" style="width: 200px; height: 120px;">
          <img src="${n}" class="w-100 h-100 object-fit-none" alt="Exemple object-fit none" loading="lazy">
        </div>
  ...
  <div class="vstack gap-2">
    ...
    <div class="border rounded p-2" style="max-width: 560px;">
      <img src="${n}" class="img-fluid img-muted" alt="Illustration d'exemple avec style atténué" loading="lazy">
    </div>
  </div>
</section>
  `,i={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de classes Bootstrap pour les images (`.img-fluid`, `.object-fit-*`) et utilitaire custom itou (`.img-muted`)."}}}},i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: renderImages,
  parameters: {
    controls: {
      disable: true
