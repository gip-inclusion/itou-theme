import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a,o,s;function c(){return(c=e((()=>{t=({modifier:e=`s-home-title-01--communaute`,title:t,lead:n,placeholder:r,searchLabel:i})=>`
<section class="s-home-title-01 ${e} mb-md-6 mb-lg-10">
            ...
            <div class="col-12">
              ...
              <div class="input-group input-group-lg flex-nowrap">
                ...
                <div class="input-group-text bg-white p-0 flex-grow-1">
                  <input id="home-title-search" type="text" class="form-control" placeholder="${r}" aria-describedby="homeSearchBtn">
                  <button class="btn btn-ico btn-primary" type="button" id="homeSearchBtn" aria-label="${i}">
...
}`,...o.parameters?.docs?.source}}},s=[`Communaute`,`Emploi`,`Pilotage`,`Marche`]})))()}c();export{r as Communaute,i as Emploi,o as Marche,a as Pilotage,s as __namedExportsOrder,n as default};