...
</div>`},a={render:s,parameters:{docs:{description:{story:"Alerte simple avec un message texte uniquement."}}},args:{variant:"info",role:"status",dismissible:!1,withIcon:!1,withTitle:!1,withAction:!1,title:"Titre de l'alerte",message:"Ceci est un message d'information simple."}},o={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Alerte avec une icône pour renforcer visuellement le type de message."}}},args:{variant:"info",role:"status",dismissible:!1,withIcon:!0,withTitle:!0,withAction:!1,title:"Information",message:"Voici un message informatif avec une icône pour attirer l'attention."}},l={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Alerte avec un bouton d'action pour permettre à l'utilisateur d'interagir."}}},args:{variant:"important",role:"status",dismissible:!0,withIcon:!0,withTitle:!0,withAction:!0,title:"Nouvelle fonctionnalité",message:"Une nouvelle fonctionnalité est disponible. Découvrez-la maintenant car elle trop top de chez top !"}},c={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Alerte de succès pour confirmer une action réussie."}}},args:{variant:"success",role:"status",dismissible:!0,withIcon:!0,withTitle:!0,withAction:!1,title:"Succès",message:"Votre action a été effectuée avec succès."}},u={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Alerte d'erreur pour signaler un problème critique. Utiliser `role=\"alert\"` pour l'accessibilité."}}},args:{variant:"danger",role:"alert",dismissible:!0,withIcon:!0,withTitle:!0,withAction:!1,title:"Erreur",message:"Une erreur s'est produite. Veuillez réessayer ultérieurement."}},d={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Alerte avec bouton de fermeture permettant à l'utilisateur de la masquer."}}},args:{variant:"warning",role:"alert",dismissible:!0,withIcon:!0,withTitle:!0,withAction:!1,title:"Attention",message:"Cette alerte peut être fermée en cliquant sur le bouton ×."}},y=({variant:t,title:n,message:e})=>{const r="alertDismissibleOnceDemo";return`
...
}`,...m.parameters?.docs?.source}}};const S=["Default","WithIcon","WithAction","Success","Danger","Dismissible","DismissibleOnce"];export{u as Danger,a as Default,d as Dismissible,m as DismissibleOnce,c as Success,l as WithAction,o as WithIcon,S as __namedExportsOrder,I as default};
