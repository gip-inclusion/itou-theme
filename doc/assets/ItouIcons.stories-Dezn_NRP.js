...
<section class="vstack gap-4">
  ...
  ${r()}
  ${i()}
</section>`,o={render:a,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Présentation complète des icônes Remixicon : poids, tailles et animation spinner.`}}}},s={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Icônes avec différents poids : normal, medium et bold.`}}}},c={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Icônes avec différentes tailles disponibles, de xs à 2x.`}}}},l={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Icônes animées avec la classe .ri-spinner pour les états de chargement ou d'attente.`}}}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
}`,...l.parameters?.docs?.source}}},u=[`Default`,`Weights`,`Sizes`,`Spinner`]})))()}d();export{o as Default,c as Sizes,l as Spinner,s as Weights,u as __namedExportsOrder,t as default};