const l={title:"Forms/ButtonsGroup",decorators:[e=>{const t=`<div style="max-width: 1000px; margin: 0 auto;">${e()}</div>`;return setTimeout(()=>{[...document.querySelectorAll('[data-bs-toggle="tooltip"]')].map(o=>new bootstrap.Tooltip(o))},0),t}],tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`Le composant \`.btn-group\` permet de regrouper une série de boutons sur une seule ligne.
...
`}}},argTypes:{size:{control:{type:"select"},options:["default","sm","lg"],description:"Taille du groupe de boutons : standard, petit (`btn-group-sm`) ou grand (`btn-group-lg`)"}}},a=({size:e})=>{const t=e==="default"?"":`btn-group-${e}`;return`
  ...
  <hr />
  <div class="btn-group ${t}" role="group" aria-label="Actions rapides sur le candidat">
  ...
  `},r={render:a,parameters:{docs:{description:{story:"Démonstration des tailles `.btn-group-lg`, défaut et `.btn-group-sm` et un exemple de `.btn-group` présent dans les tablaux de résultats."}}},args:{size:"sm"}},s=({size:e})=>`
  ...
  `,n={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variation Itou avec `.btn-group-action` pour des actions rapides icône seule."}}},args:{size:"sm"}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: render,
  parameters: {
    docs: {
      description: {
...
}`,...n.parameters?.docs?.source}}};const u=["Default","ActionGroup"];export{n as ActionGroup,r as Default,u as __namedExportsOrder,l as default};
