...
`}}}},p=()=>`
  ...
  `,e={render:p,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemples de base avec un popover simple et une variante avec titre, conformes aux exemples Bootstrap et au HTML du projet."}}}},t={render:c,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Le popover peut etre positionne en haut, a droite, en bas ou a gauche via `data-bs-placement`."}}}},o={render:l,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Cas historique de l'ancienne documentation : ouverture au survol. La story utilise `hover focus` pour conserver un acces clavier minimal."}}}},r={render:d,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:'Pattern Bootstrap avec `data-bs-trigger="focus"` pour fermer le popover au prochain clic hors du declencheur.'}}}},n={render:u,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Pour un element desactive, le popover doit etre porte par un wrapper focusable, et non par le bouton `disabled` lui-meme."}}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
