import{n as e}from"./rolldown-runtime-DkW27tQK.js";function t(){let e=document.getElementById(`liveToastBtn`);!e||e.dataset.itToastBound===`true`||(e.addEventListener(`click`,function(){let e=document.querySelector(`.toast-container`);e&&[].slice.call(e.querySelectorAll(`.toast`)).map(function(e){return new bootstrap.Toast(e)}).forEach(e=>e.show())}),e.dataset.itToastBound=`true`)}var n,r,i,a,o,s,c,l;function u(){return(u=e((()=>{n={title:`Components/Toasts`,decorators:[e=>{let n=`<div style="max-width: 1000px; margin: 0 auto;">${e()}</div>`;return setTimeout(()=>{t()},0),n}],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:'\nLe composant `.toast` permet d\'afficher des notifications legeres et non bloquantes.\nDans le theme itou, des variantes de couleur sont disponibles via `.toast--info`, `.toast--warning`, `.toast--danger` et `.toast--success`.\nPour le positionnement et le staking des Toasts il faut placer les `.toast` dans le wrapper `.toast-container`.\n\n### Anatomie\n1. **Conteneur de stack** - `.toast-container` pour gerer le positionnement et l\'empilement\n2. **Toast** - Bloc `.toast` avec role ARIA adapte\n3. **Header** - `.toast-header` avec titre et bouton de fermeture\n4. **Body** - `.toast-body` avec le message\n\n### Classes CSS\n| Classe | Description |\n|--------|-------------|\n| `.toast` | Toast de base Bootstrap |\n| `.toast-container` | Wrapper de positionnement/stacking |\n| `.toast--info` | Variante information |\n| `.toast--warning` | Variante avertissement |\n| `.toast--danger` | Variante erreur |\n| `.toast--success` | Variante succes |\n\n### Accessibilité\n- Placer les toasts dans une region live existante en amont de l\'affichage.\n- Utiliser `role="status" aria-live="polite"` pour les messages non critiques.\n- Utiliser `role="alert" aria-live="assertive"` pour les messages importants.\n- Si `autohide` est désactivé, fournir un bouton de fermeture explicite.\n\n**Documentation Bootstrap** : <a href="https://getbootstrap.com/docs/5.3/components/toasts/" target="_blank" rel="noopener noreferrer" class="has-external-link">Toasts</a>\n'}}}},r=({variant:e,polite:t,delay:n,autohide:r})=>`
  ...
  `,o={render:r,args:{variant:`default`,polite:!0,delay:5e3,autohide:!0},parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Toast unitaire avec variantes structurelles (`aria-live`, `autohide`, `delay`) fixees dans la story."}}}},s={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variantes etat du theme itou: `default`, `info`, `danger`, `success`, `warning`."}}}},c={render:a,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemple de declenchement JS d'un toast via `#liveToastBtn`, en reprenant le pattern de `components.html` (query du `.toast-container`, creation des instances Bootstrap, puis `show()`)."}}}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: renderToast,
  args: {
    variant: "default",
    polite: true,
...
}`,...c.parameters?.docs?.source}}},l=[`Default`,`States`,`LiveExample`]})))()}u();export{o as Default,c as LiveExample,s as States,l as __namedExportsOrder,n as default};