...
`,o={render:d,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Le `.c-box` est utilisé pour enrober du contenu et créer une zone délimitée."}}}},s={render:c,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Le `.c-form` est utilisé pour enrober un formulaire, il possède de nombreuses sous-classes et règles descendantes pour les éléments de formulaires qu'il contient."}}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: renderBox,
  parameters: {
    controls: {
      disable: true
...
}`,...s.parameters?.docs?.source}}};const p=["Box","Form"];export{o as Box,s as Form,p as __namedExportsOrder,m as default};
