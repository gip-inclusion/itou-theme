...
<section class="vstack gap-3">
  ...
  `,r={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Titres sémantiques et classes `.h*` Bootstrap."}}}},i=()=>`
<section class="vstack gap-3">
  ...
  `,a={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Exemples de tailles, graissages, interlignage et familles de polices (Bootstrap + custom itou).`}}}},o=()=>`
  ...
  `,s={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Éléments inline et formats de listes de la documentation typographique Bootstrap.`}}}},c=()=>`
...
<section class="vstack gap-3">
  ...
  `,d={render:u,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Type de liens possibles.`}}}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...d.parameters?.docs?.source}}},f=[`Headings`,`SizesWeightsAndLineHeight`,`Lists`,`Quotes`,`Links`]})))()}p();export{r as Headings,d as Links,s as Lists,l as Quotes,a as SizesWeightsAndLineHeight,f as __namedExportsOrder,t as default};