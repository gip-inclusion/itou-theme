const c={title:"Utilities/Text Utilities",decorators:[t=>`<div style="max-width: 1000px; margin: 0 auto;">${t()}</div>`],tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
<section class="vstack gap-3">
  ...
  `,e={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Utilitaires texte : alignement, casse, retour à la ligne, style et états (Bootstrap + custom itou)."}}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
