const c={title:"Components/Box Action",decorators:[r=>`<div style="max-width: 1000px; margin: 0 auto;">${r()}</div>`],tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`,e={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Barre d'action standard avec 2 actions principales et un dropdown de transfert."}}}},s=()=>`
<div class="c-box c-box--action">
...
`,t={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante orientée traitement de candidature, inspirée des écrans métier historiques."}}}},i=()=>`
<div class="c-box c-box--action">
    <h2 class="visually-hidden">Actions rapides</h2>
    <div class="form-row align-items-center gx-3">
        <div class="form-group col-12 col-lg-auto">
...
`,n={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante avec un compteur d'actions possibles dans le dropdown."}}}},d=()=>`
<div class="c-box c-box--action">
  <h2 class="visually-hidden">Actions rapides</h2>
  <div class="form-row align-items-center gx-3">
    <div class="form-group col-12 col-lg-auto">
...
`,a={render:d,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemple avec actions d'orientation de candidatures et menu dropdown compact."}}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
...
}`,...a.parameters?.docs?.source}}};const l=["BarreActionStandard","BarreActionTraitement","BarreActionLegacy","BarreActionOrientation"];export{n as BarreActionLegacy,a as BarreActionOrientation,e as BarreActionStandard,t as BarreActionTraitement,l as __namedExportsOrder,c as default};
