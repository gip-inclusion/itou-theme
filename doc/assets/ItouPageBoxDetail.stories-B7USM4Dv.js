...
`,o={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Démo en page simple, sans onglets et avec plusieurs `.c-box` de contenu séparé."}}}},s={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Démo en page simple, sans onglets mais avec une seule `.c-box` et du contenu séparé par `<hr>` et titre en `<h3>`."}}}},c={render:a,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Démo avec onglets avec plusieurs `.c-box` de contenu séparé."}}}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
}`,...c.parameters?.docs?.source}}},l=[`SansOngletsMultiBox`,`SansOngletsMonoBox`,`AvecOngletsMultibox`]})))()}u();export{c as AvecOngletsMultibox,s as SansOngletsMonoBox,o as SansOngletsMultiBox,l as __namedExportsOrder,n as default};