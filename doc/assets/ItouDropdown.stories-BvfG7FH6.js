import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a,o,s,c,l,u,d,f,p,m,h,g;function _(){return(_=e((()=>{t={title:`Components/Dropdown`,decorators:[e=>`<div style="max-width: 1000px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:'\nLe composant `.dropdown` permet d\'afficher un menu contextuel declenche par un bouton.\nIl repose sur le plugin JavaScript Bootstrap (Popper) pour la gestion du positionnement et de l\'ouverture/fermeture.\n\n### Anatomie\n1. **Conteneur** - Bloc parent `.dropdown`\n2. **Déclencheur** - `<button class="dropdown-toggle">` avec `data-bs-toggle="dropdown"`\n3. **Menu** - `.dropdown-menu` associe au déclencheur\n4. **Items** - `.dropdown-item` (liens, boutons, contenus custom)\n\n### Classes CSS\n| Classe | Description |\n|--------|-------------|\n| `.dropdown` | Conteneur principal |\n| `.dropdown-toggle` | Bouton de declenchement |\n| `.dropdown-menu` | Panneau du menu |\n| `.dropdown-item` | Entree actionnable |\n| `.dropdown-header` | Titre de `<section>` |\n| `.dropdown-divider` | Séparateur visuel |\n| `.dropdown-organization` | Variante itou pour les listes de structures |\n\n### Accessibilité\n- Conserver `aria-expanded` sur le déclencheur (mis a jour par Bootstrap).\n- Relier le bouton et le menu via `aria-controls` ou `aria-labelledby`.\n- Sur les icônes decoratives, utiliser `aria-hidden="true"`.\n\n**Documentation Bootstrap** : <a href="https://getbootstrap.com/docs/5.3/components/dropdowns/" target="_blank" rel="noopener noreferrer" class="has-external-link">Dropdowns</a>\n'}}},argTypes:{triggerVariant:{control:{type:`select`},options:[`btn-primary`,`btn-outline-primary`,`btn-link`],description:`Style visuel du bouton déclencheur`},triggerLabel:{control:`text`,description:`Libelle du bouton déclencheur`}}},n=({triggerVariant:e,triggerLabel:t})=>{let n=`dropdown-${Math.random().toString(36).slice(2,10)}`;return`
  ...
  `},r=()=>{let e=`dropdown-header-${Math.random().toString(36).slice(2,10)}`;return`
  ...
  `},i=()=>{let e=`dropdown-org-header-${Math.random().toString(36).slice(2,10)}`;return`
  ...
  `},a=()=>{let e=`dropdown-org-transfer-${Math.random().toString(36).slice(2,10)}`;return`
  ...
  `},o=()=>{let e=`dropdown-nexus-${Math.random().toString(36).slice(2,10)}`;return`
  ...
  `},s=()=>{let e=`dropdown-nexus-nopc-${Math.random().toString(36).slice(2,10)}`;return`
    <div style="max-width: 420px; min-height: 420px;">
      <div class="dropdown dropdown-nexus">
        <button class="btn btn-outline-primary btn-block bg-white dropdown-toggle" type="button" id="${e}" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span>Mon portail</span>
  ...
  `},c=()=>{let e=`dropdown-nexus-noaccount-${Math.random().toString(36).slice(2,10)}`;return`
    <div style="max-width: 420px; min-height: 420px;">
      <div class="dropdown dropdown-nexus">
        <button class="btn btn-outline-primary btn-block bg-white dropdown-toggle" type="button" id="${e}" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span>Mon portail</span>
  ...
  `},l={render:n,args:{triggerVariant:`btn-primary`,triggerLabel:`Dropdown`},parameters:{docs:{description:{story:`Exemple de base configurable avec menu d'actions, item actif et séparateur.`}}}},u={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante avec sections de menu, titres (`.dropdown-header`) et séparateur (`.dropdown-divider`)."}}}},d={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante itou `dropdown-organization dropdown-header-menu` utilisee pour le switch de structure dans le header."}}}},f={render:a,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante itou `dropdown-organization` utilisee dans le workflow de transfert de candidature."}}}},p={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante `dropdown-nexus` standard avec services actifs et activables."}}}},m={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante `dropdown-nexus` quand l'utilisateur n'a pas de compte Pro Connect."}}}},h={render:c,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante `dropdown-nexus` quand l'utilisateur n'a pas encore de compte Emplois de l'inclusion."}}}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: renderBasic,
  args: {
...
}`,...h.parameters?.docs?.source}}},g=[`Default`,`WithHeaderAndDivider`,`OrganizationHeaderMenu`,`OrganizationTransferMenu`,`NexusDefault`,`NexusWithoutProConnect`,`NexusWithoutEmploisAccount`]})))()}_();export{l as Default,p as NexusDefault,h as NexusWithoutEmploisAccount,m as NexusWithoutProConnect,d as OrganizationHeaderMenu,f as OrganizationTransferMenu,u as WithHeaderAndDivider,g as __namedExportsOrder,t as default};