const s={title:"Libraries/Tarte au citron",decorators:[t=>`<div style="max-width: 1000px; margin: 0 auto;">${t()}</div>`],tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`}}}},r=`tarteaucitron.init({
  ...
  "partnersList": false
    ...
    <article class="row py-3">
      <div class="col-12">
        ...
        <pre class="bg-info-lighter p-3"><code>${r.replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
  ...
  `,e={render:a};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render
