import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i;function a(){return(a=e((()=>{t={title:`Components/Navinfo`,decorators:[e=>`<div style="max-width: 1000px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`}}},argTypes:{withInformation:{control:`boolean`,description:`Affiche l'information complémentaire`},withPrevnext:{control:`boolean`,description:`Affiche les liens de navigations`}}},n=({withInformation:e,withPrevnext:t})=>`
<div class="c-navinfo">
  ...
  ${t?`  <div class="c-navinfo__prevnext">
  ...
  ${e?`<div class="c-navinfo__info">
    Mise a jour le 14/03/25
  </div>`:``}
</div>
`,r={render:n,args:{withInformation:!0,withPrevnext:!0}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render,
  args: {
