import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i;function a(){return(a=e((()=>{t=()=>`
...
`,n={title:`Sections/ArticleCols01`,decorators:[e=>`<div style="max-width: 1200px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`}}}},r={render:t,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Version standard de la section multicolonne.`}}}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...r.parameters?.docs?.source}}},i=[`Default`]})))()}a();export{r as Default,i as __namedExportsOrder,n as default};