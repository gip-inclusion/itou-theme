import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a,o,s,c,l,u,d,f;function p(){return(p=e((()=>{t={title:`Utilities/Sizing`,decorators:[e=>`<div style="max-width: 1200px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`}}}},n=[{token:`25`,css:`25%`},{token:`33`,css:`33%`},{token:`40`,css:`40%`},{token:`50`,css:`50%`},{token:`66`,css:`66%`},{token:`75`,css:`75%`},{token:`50px`,css:`50px`},{token:`100px`,css:`100px`},{token:`200px`,css:`200px`},{token:`300px`,css:`300px`},{token:`400px`,css:`400px`}],r=[{token:`25`,css:`25%`},{token:`33`,css:`33%`},{token:`50`,css:`50%`},{token:`66`,css:`66%`},{token:`75`,css:`75%`}],i=[{token:`25`,css:`25%`},{token:`33`,css:`33%`},{token:`50`,css:`50%`},{token:`66`,css:`66%`},{token:`75`,css:`75%`},{token:`25vh`,css:`25vh`},{token:`33vh`,css:`33vh`},{token:`50vh`,css:`50vh`},{token:`66vh`,css:`66vh`},{token:`75vh`,css:`75vh`},{token:`100vh`,css:`100vh`}],a=(e,t,n)=>`
<div class="col-12 col-lg-4">
  <div class="card h-100">
    <div class="card-header"><strong>${e}</strong></div>
    <div class="card-body p-0">
      <div class="table-responsive">
        <table class="table table-sm mb-0">
          ...
          <tbody>${n.map(({token:e,css:n})=>`<tr><td><code>.${t}-${e}</code></td><td>${n}</td></tr>`).join(``)}</tbody>
        </table>
      </div>
    </div>
  </div>
...
<section class="vstack gap-4">
  ...
  `,d={render:u,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Référence des utilitaires de dimensionnement et exemples visuels (`w-*`, `mw-*`, `mh-*`)."}}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render,
  parameters: {
    controls: {
      disable: true
...
}`,...d.parameters?.docs?.source}}},f=[`Default`]})))()}p();export{d as Default,f as __namedExportsOrder,t as default};