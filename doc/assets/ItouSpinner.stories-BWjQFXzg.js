import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a,o,s,c;function l(){return(l=e((()=>{t={title:`Components/Spinner`,decorators:[e=>`<div style="max-width: 1000px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`
...
`}}}},n=()=>`
  ...
  `,r={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Spinner Bootstrap simple pour indiquer un chargement ponctuel.`}}}},i=()=>`
<div class="card c-card has-spinner-loading" role="status">
  ...
  `,a={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Application de `.has-spinner-loading` sur un conteneur HTML (exemple carte)."}}}},o=()=>`
<button type="button" disabled class="btn btn-ico btn-primary has-spinner-loading">
  ...
  `,s={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Application de `.has-spinner-loading` directement sur un `.btn`."}}}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...s.parameters?.docs?.source}}},c=[`Default`,`SpinnerOnContainer`,`SpinnerOnButton`]})))()}l();export{r as Default,s as SpinnerOnButton,a as SpinnerOnContainer,c as __namedExportsOrder,t as default};