function p(){const s=document.querySelectorAll("[data-it-clipboard-button=copy]");for(let t=0,a=s.length;t<a;t+=1){const e=s[t],c=e.dataset.itCopyToClipboard,r=bootstrap.Tooltip.getOrCreateInstance(e);e.addEventListener("click",function(){e.hasAttribute("aria-describedby")||(r.show(),navigator.clipboard.writeText(c).then(()=>{}).catch(()=>{}))}),e.addEventListener("blur",function(){r.hide()})}}const d=({withCopyButtons:s=!0,withWebsiteLink:t=!0,withMissingValues:a,withLongText:e})=>`
<ul class="list-data">
  <li>
    <small>Prenom</small>
    <strong>Jean</strong>
  ...
  <li>
    ...
    ${t?'<a href="" class="btn-link has-external-link">siteweb.com</a>':"<strong>siteweb.com</strong>"}
  </li>
  <li>
...
}`,...o.parameters?.docs?.source}}};const L=["Default","WithLongContent","CompleteData","ListdataGroup"];export{l as CompleteData,i as Default,o as ListdataGroup,n as WithLongContent,L as __namedExportsOrder,y as default};
