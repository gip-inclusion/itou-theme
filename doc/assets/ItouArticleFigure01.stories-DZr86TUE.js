...
`}}}},e={render:()=>i({hasCta:!1}),parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Version par defaut sans CTA, conforme a la structure de base de la section."}}}},r={render:()=>i({modifier:"s-article-figure-01--ltr",hasCta:!0}),parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante avec modifieur `--ltr`."}}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
