...
`,e={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"La règle horizontale standard."}}}},t={render:s,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"la règle horizontale avec marges personnalisées."}}}},r={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"la règle horizontale en variante avec texte central."}}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
