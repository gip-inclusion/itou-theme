const n={title:"Components/Box Partenaire",decorators:[r=>`<div style="max-width: 1000px; margin: 0 auto;">${r()}</div>`],tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`,e={render:a,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`
...
}`,...e.parameters?.docs?.source}}};const t=["Default"];export{e as Default,t as __namedExportsOrder,n as default};
