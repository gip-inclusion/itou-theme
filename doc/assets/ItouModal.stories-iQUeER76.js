import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t,n,r,i,a,o,s,c;function l(){return(l=e((()=>{t={title:`Components/Modal`,decorators:[e=>`<div style="max-width: 1000px; margin: 0 auto;">${e()}</div>`],tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:'\nLe composant `.modal` affiche un dialogue superpose pour presenter un contenu important ou une action de confirmation.\nIl est base sur Bootstrap et gere automatiquement l\'ouverture, la fermeture et l\'isolation visuelle de l\'arriere-plan.\n\n### Anatomie\n1. **Déclencheur** - Bouton/lien avec `data-bs-toggle="modal"` et `data-bs-target`\n2. **Conteneur modal** - `.modal` avec `aria-hidden` et `tabindex="-1"`\n3. **Dialogue** - `.modal-dialog` (optionnellement `.modal-dialog-centered`)\n4. **Contenu** - `.modal-content` avec `.modal-header`, `.modal-body`, `.modal-footer`\n\n### Classes CSS\n| Classe | Description |\n|--------|-------------|\n| `.modal` | Wrapper principal de la modale |\n| `.modal-dialog` | Cadre de positionnement et dimensions |\n| `.modal-dialog-centered` | Centrage vertical |\n| `.modal-content` | Conteneur visuel de la modale |\n| `.modal-header` | Entete avec titre et bouton fermer |\n| `.modal-body` | Contenu principal |\n| `.modal-footer` | Zone d\'actions |\n\n### Accessibilité\n- Associer le titre au dialogue via `aria-labelledby`.\n- Conserver un bouton de fermeture explicite avec `aria-label`.\n- Utiliser des libelles d\'actions explicites dans le `<footer>`.\n- Eviter les contenus trop longs sans structure (titres, listes, paragraphes).\n\n**Documentation Bootstrap** : <a href="https://getbootstrap.com/docs/5.3/components/modal/" target="_blank" rel="noopener noreferrer" class="has-external-link">Modal</a>\n'}}}},n=()=>{let e=`modal-default-${Math.random().toString(36).slice(2,10)}`,t=`modal-default-title-${Math.random().toString(36).slice(2,10)}`;return`
  ...
  `},r=()=>{let e=`modal-mini-${Math.random().toString(36).slice(2,10)}`,t=`modal-mini-title-${Math.random().toString(36).slice(2,10)}`;return`
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#${e}">
    ...
    <div class="modal fade" id="${e}" tabindex="-1" aria-labelledby="${t}" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="${t}">Profitez du Marche en totalite Titre sur deux lignes</h3>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
          </div>
  ...
  `},i=()=>{let e=`modal-delete-comment-${Math.random().toString(36).slice(2,10)}`,t=`delete-comment-title-${Math.random().toString(36).slice(2,10)}`;return`
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#${e}">
    ...
    <div class="modal fade" id="${e}" tabindex="-1" aria-labelledby="${t}" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h3 id="${t}" class="modal-title">Suppression du commentaire</h3>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
          </div>
          <div class="modal-body">
            <div class="row">
  ...
  `},a={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Modale Bootstrap standard avec centrage vertical.`}}}},o={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Variante de modale orientee contenu marketing (liste de benefices et double CTA).`}}}},s={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Variante de modale de confirmation pour suppression d'un commentaire.`}}}},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
...
}`,...s.parameters?.docs?.source}}},c=[`Default`,`MarketingModal`,`DeleteCommentModal`]})))()}l();export{a as Default,s as DeleteCommentModal,o as MarketingModal,c as __namedExportsOrder,t as default};