      ...
      <div class="card-body p-0">
        <div class="table-responsive">
          <table class="table table-sm mb-0">
            ...
            <tbody>
              ${t.map(({key:r,formula:s,rem:o,px:a})=>`<tr><td><code>${r}</code></td><td><code>${s}</code></td><td>${o}</td><td>${a}</td></tr>`).join("")}
            </tbody>
          </table>
        </div>
      </div>
