...
`,a={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Version issue de `components.html` avec onglet actif, item avec badge, item avec icone et item desactive."}}}},t={render:l,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:'Exemple Bootstrap complet avec `data-bs-toggle="tab"` et panneaux `.tab-pane` relies en ARIA.'}}}},n={render:i,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante verticale avec `.flex-column`, conforme a la doc HTML du theme."}}}},s={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Variante verticale ordonnee sur `ol` avec `.nav-tabs-sm` et badges d'avancement."}}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: renderBasic,
  parameters: {
    controls: {
      disable: true
