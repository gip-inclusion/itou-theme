...
`,i={render:n,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Version detail de la page formulaire avec stepper, formulaire principal et box organization latérale.`}}}},a={render:r,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:`Exemple de formulaire de modification d'informations personnelles avec alerte contextuelle et champs d'identification.`}}}},o=()=>`
<main id="main" role="main" class="s-main">
  <section class="s-title-02">
    <div class="s-title-02__container container">
      <div class="s-title-02__row row">
...
`,s={render:o,parameters:{controls:{disable:!0},docs:{controls:{disable:!0},description:{story:"Exemple avec plusieurs `<fieldset>` séparés par des lignes `<hr>`. Pour les formulaires organisés en sections multiples (Qualification, Ressources, Situation professionnelle, Handicap, etc.)."}}}},i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render,
  parameters: {
    controls: {
      disable: true
...
}`,...s.parameters?.docs?.source}}},c=[`Default`,`InformationsPersonnelles`,`AvecPlusieursFieldsets`]})))()}l();export{s as AvecPlusieursFieldsets,i as Default,a as InformationsPersonnelles,c as __namedExportsOrder,t as default};