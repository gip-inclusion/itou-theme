...
const renderPostesOuvertsAuRecrutement = () => `
<div class="c-box c-box--results has-links-inside my-3 my-md-4">
  <div class="c-box--results__header">
    <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
...
export const PostesOuvertsAuRecrutement = {
...
export const SalariesEtPassIAE = {
...
const renderControleAPosterioriDDETSSiae = () => `
<div class="c-box c-box--results has-links-inside">
  <div class="c-box--results__header">
    <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
      <div class="c-box--results__summary flex-grow-1">
...
export const ControleAPosterioriDDETSSiae = {
...
const renderControleAPosterioriDDETSAutoPrescription = () => `
<div class="c-box c-box--results has-links-inside">
  <div class="c-box--results__header">
    <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
      <div class="c-box--results__summary flex-grow-1">
...
export const ControleAPosterioriDDETSAutoPrescription = {
...
const renderControleAPosterioriSIAEAutoPrescription = () => `
<div class="c-box c-box--results has-links-inside">
  <div class="c-box--results__header">
    <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
      <div class="c-box--results__summary flex-grow-1">
...
export const ControleAPosterioriSIAEAutoPrescription = {
