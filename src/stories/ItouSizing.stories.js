...
const widthValues = [
  ...
  { token: "75", css: "75%" },
  { token: "50px", css: "50px" },
  { token: "100px", css: "100px" },
  { token: "200px", css: "200px" },
  { token: "300px", css: "300px" },
  { token: "400px", css: "400px" },
];
...
const maxHeightValues = [
  ...
  { token: "66vh", css: "66vh" },
  { token: "75vh", css: "75vh" },
  { token: "100vh", css: "100vh" },
];

const renderValuesTable = (title, prefix, values) => {
  const rows = values
    .map(({ token, css }) => `<tr><td><code>.${prefix}-${token}</code></td><td>${css}</td></tr>`)
    .join("");
...
const renderValuesTables = () => {
  return `
<div class="row g-3">
  ${renderValuesTable("Width", "w", widthValues)}
  ${renderValuesTable("Max-width", "mw", maxWidthValues)}
  ${renderValuesTable("Max-height", "mh", maxHeightValues)}
</div>
  `;
};

const renderWidthExamples = () => {
  return `
<div class="card">
...
<section class="vstack gap-4">
  ${renderValuesTables()}
  ${renderWidthExamples()}
  ${renderMaxWidthExamples()}
  ${renderMaxHeightExamples()}
</section>
  `;
};
