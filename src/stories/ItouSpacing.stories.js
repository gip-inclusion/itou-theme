...
const spacers = [
  { key: 0, formula: "0", rem: "0", px: "0px" },
  { key: 1, formula: "$spacer * 0.25", rem: "0.25rem", px: "4px" },
  { key: 2, formula: "$spacer * 0.5", rem: "0.5rem", px: "8px" },
  { key: 3, formula: "$spacer", rem: "1rem", px: "16px" },
  { key: 4, formula: "$spacer * 1.5", rem: "1.5rem", px: "24px" },
  { key: 5, formula: "$spacer * 2", rem: "2rem", px: "32px" },
  { key: 6, formula: "$spacer * 3", rem: "3rem", px: "48px" },
  { key: 7, formula: "$spacer * 4", rem: "4rem", px: "64px" },
  { key: 8, formula: "$spacer * 5", rem: "5rem", px: "80px" },
  { key: 9, formula: "$spacer * 6", rem: "6rem", px: "96px" },
  { key: 10, formula: "$spacer * 8", rem: "8rem", px: "128px" },
];

const renderSyntaxTable = () => {
  const rows = spacers
    .map(({ key, formula, rem, px }) => `<tr><td><code>${key}</code></td><td><code>${formula}</code></td><td>${rem}</td><td>${px}</td></tr>`)
    .join("");
