  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        layout_itou_not_authenticated_signup_proconnect: resolve(__dirname, "src/layout-itou-not-authenticated-signup-step-proconnect.html"),
        layout_itou_not_authenticated_signup_structure: resolve(__dirname, "src/layout-itou-not-authenticated-signup-step-structure.html"),
        layout_itou_not_authenticated_signup_confirmation: resolve(__dirname, "src/layout-itou-not-authenticated-signup-step-confirmation.html"),
        layout_not_itou_pilotage_form: resolve(__dirname, "src/layout-not-itou-pilotage-form.html"),
